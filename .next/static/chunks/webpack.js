/******/ (function(modules) {
	...
	/******/ /******/ var hotCurrentHash = 'c7219056d49f269d7cec';
				...
				/******/ switch (hotStatus) {
					...
					/******/ case 'apply':
						/******/ (hotQueuedInvalidatedModules =
							/******/ hotQueuedInvalidatedModules || []).push(
							moduleId
						);
						/******/ break;
					/******/ default:
	...
	/******/ function hotCheck(apply) {
		...
		/******/ return hotDownloadManifest(hotRequestTimeout).then(function(
			...
			/******/ if (!update) {
				/******/ hotSetStatus(
					hotApplyInvalidatedModules() ? 'ready' : 'idle'
				);
				/******/ return null;
				/******/
			}
	...
	/******/ function hotApplyInvalidatedModules() {
		/******/ if (hotQueuedInvalidatedModules) {
			...
			/******/ hotQueuedInvalidatedModules.forEach(
				hotApplyInvalidatedModule
			);
