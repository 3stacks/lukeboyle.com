            ...
            <div className="max-width-container">
                ...
                <div className="single-portfolio-item">
                    ...
                    <div className="single-portfolio-item__buttons">
                        <a target="_blank" className="single-portfolio-item__link button primary" href="http://3stacks.github.io/type-with-apps">
                            View live site
                        </a>
                        <a target="_blank" className="single-portfolio-item__link button primary" href="https://github.com/3stacks/type-with-apps">
                            See repository
                        </a>
                    </div>
                </div>
