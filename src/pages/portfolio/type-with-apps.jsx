            ...
            <div className="max-width-container">
                ...
                <div className="single-portfolio-item">
                    ...
                    <div className="single-portfolio-item--content">
                        <p>Type With Apps is the result of a hack session in a laundromat. What started as simply replicating the iOS homescreen in <strong>Angular 1.5</strong> ended as a …</p>
                        <h2>Challenges</h2>
