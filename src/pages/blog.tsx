                            ...
                            <PostArchive
                                data={{
                                    '2016': {
                                        '10': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2016/10/running-karma-tests-for-chrome-in-travis-ci.md',
                                                title:
                                                    'Running Karma tests for Chrome in Travis CI'
                                            },
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2016/10/local-storage-manager-version-2-1-is-out-now.md',
                                                title:
                                                    'Local Storage Manager version 2.1 is out now'
                                            }
                                        ],
                                        '12': [
                                            {
                                                slug: 'top-15-albums-of-2016',
                                                path:
                                                    'blog-posts/2016/12/top-15-albums-of-2016.md',
                                                title: 'Top 15 Albums of 2016'
                                            },
                                            {
                                                slug:
                                                    'automating-css-regression-testing-with-argus-eyes--phantom-js',
                                                path:
                                                    'blog-posts/2016/12/automating-css-regression-testing-with-argus-eyes--phantom-js.md',
                                                title:
                                        ...
                                        '09': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2016/09/react-material-ui-touch-events-not-firing.md',
                                                title:
                                                    'React Material-UI touch events not firing'
                                            },
                                            {
                                                slug: 'jsx-in-vue-js',
                                                path:
                                                    'blog-posts/2016/09/jsx-in-vue-js.md',
                                                title: 'JSX in Vue.JS'
                                            },
                                            {
                                                slug:
                                                ...
                                                path:
                                                    'blog-posts/2016/09/essential-hip-hop-albums-of-the-decade-so-far.md',
                                                title:
                                                    'Essential Hip-Hop Albums of the Decade so far.'
                                            }
                                        ],
                                        '08': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2016/08/publishing-react-components-to-npm.md',
                                                title:
                                                    'Publishing React components to npm'
                                            },
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2016/08/dynamic-product-filtering-in-shopify.md',
                                                title:
                                                    'Dynamic Product Filtering in Shopify'
                                            }
                                        ],
                                        '06': [
                                            {
                                                slug: 'agander-2-0-is-now-out',
                                                path:
                                                    'blog-posts/2016/06/agander-2-0-is-now-out.md',
                                                title: 'Agander 2.0 is now out.'
                                            }
                                        ],
                                        '04': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2016/04/why-i-cancelled-my-spotify-subscription.md',
                                                title:
                                                    'Why I cancelled my Spotify subscription.'
                                            },
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2016/04/i-forced-myself-to-make-meaningful-github-commits-for-30-days.md',
                                                title:
                                                    'I forced myself to make meaningful Github commits for 30 days.'
                                            },
                                            {
                                                slug:
                                                    'google-calendar-api---color-id',
                                                path:
                                                    'blog-posts/2016/04/google-calendar-api---color-id.md',
                                                title:
                                                    'Google Calendar API - ColorId'
                                            },
                                            {
                                                slug: 'agander-1-0-is-now-out',
                                                path:
                                                    'blog-posts/2016/04/agander-1-0-is-now-out.md',
                                                title: 'Agander 1.0 is now out.'
                                            }
                                        ],
                                        '03': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2016/03/google-task-javascript-api---invalid-value-400-error.md',
                                                title:
                                                    'Google Task Javascript API - Invalid Value 400 Error'
                                            }
                                        ]
                                    ...
                                    '2017': {
                                        '12': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2017/12/project-estimations-made-easy.md',
                                                title:
                                                    'Project estimations made easy'
                                            }
                                        ],
                                        '04': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2017/04/css-variables--a-case-study.md',
                                                title:
                                                    'CSS Variables: A Case Study'
                                            }
                                        ],
                                        '01': [
                                            {
                                                slug:
                                                    'functional-form-validation-in-java-script--aka--inheriting-bad-java-script',
                                                path:
                                                    'blog-posts/2017/01/functional-form-validation-in-java-script--aka--inheriting-bad-java-script.md',
                                                title:
                                    ...
                                    '2018': {
                                        '11': [
                                            {
                                                slug: 'top-albums-of-2018',
                                                path:
                                                    'blog-posts/2018/11/top-albums-of-2018.md',
                                                title: 'Top albums of 2018'
                                            },
                                            {
                                                slug: 'top-albums-of-2017',
                                                path:
                                                    'blog-posts/2018/11/top-albums-of-2017.md',
                                                title: 'Top albums of 2017'
                                            },
                                            {
                                                slug: 'mac-miller',
                                                path:
                                                    'blog-posts/2018/11/mac-miller.md',
                                                title: 'Mac Miller'
                                            },
                                            {
                                                slug:
                                                    'case-study-for-iterative-development',
                                                path:
                                                    'blog-posts/2018/11/case-study-for-iterative-development.md',
                                                title:
                                        ...
                                        '12': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2018/12/software-i-actually-believe-in.md',
                                                title:
                                                    'Software I actually believe in'
                                            }
                                        ],
                                        '01': [
                                            {
                                                slug:
                                                    'converting-wordpress-site-to-static',
                                                path:
                                                    'blog-posts/2018/01/converting-wordpress-site-to-static.md',
                                                title:
                                        ...
                                        '08': [
                                            {
                                                ...
                                                path:
                                                    'blog-posts/2019/08/github-actions-for-web-apps.md',
                                                title:
                                                    'Github Actions for web apps\r'
                                            }
                                        ],
                                        '07': [
                                            {
                                                slug: 'top-albums-of-2019',
                                                path:
                                                    'blog-posts/2019/07/top-albums-of-2019.md',
