...
export default function TopPart({children, ...otherProps}) {
    return (<html>
        <head>
            ...
            <script>
                {/*{window.ga=window.ga||function(){(ga.q=ga.q||[]).push(arguments)};ga.l=+new Date;ga('create', 'UA-84326776-1', 'auto');ga('send', 'pageview');}*/}
            </script>
